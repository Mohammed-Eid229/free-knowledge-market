<?php
  ...
  if (isset($_POST['delete'])){
    if(!empty($_POST['deleteInput'])){
      $admin->deleteUser($_POST['deleteInput']);
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
        <a class="nav-link active bg-gradient-dark text-white" href="manageUsersAccounts.php">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="adminprofile.php">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Manage Users Accounts</li>
          </ol>
        </nav>
          </div>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Users Accounts</h6>
              </div>
            </div>
                      ...
                      <td>
                        ...
                        <div class="rounded-circle overflow-hidden" style="width: 50px; height: 50px; margin-right: 10px;">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $user["username"]?></h6>
                            <p class="text-xs text-secondary mb-0"><?php echo $user["email"]?></p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $user["name"]?></p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $user["points"]?></p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><?php echo $user["badge"]?></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $user["joinDate"]?></span>
                      </td>
                      <td class="align-middle">
                        <div class="d-flex align-items-center gap-2">
                          <form action="manageUsersaccounts.php" method="POST">
                            <input type="hidden" name="deleteInput" value="<?php echo  $user["ID"];?>">
                            <button type="submit" name="delete" class="btn btn-outline-danger">
                              <span><i class="material-symbols-rounded opacity-8">delete</i></span>
                            </button>
                          </form>
